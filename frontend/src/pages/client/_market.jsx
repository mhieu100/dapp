...
import { Select, Tag, Pagination, Form, Input, Button, Row, Col, Card, Empty, Space, Breadcrumb, message } from 'antd';
import { FilterOutlined, CalendarOutlined, DollarOutlined, UserOutlined } from '@ant-design/icons';
            ...
            <div className="min-h-screen bg-gray-50 pt-16">
                <section className="py-8">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mb-6">
                            <h1 className="text-2xl font-bold text-gray-900">Danh sách Vaccine</h1>
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-4">
                                                <div className="h-12 w-12 rounded-lg bg-blue-50 flex items-center justify-center">
                                                    <i className="fas fa-syringe text-brand-primary text-xl"></i>
                                                </div>
