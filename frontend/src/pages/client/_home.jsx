...
import { ShoppingOutlined, CalendarOutlined, SafetyCertificateOutlined, TeamOutlined, FileProtectOutlined, RocketOutlined, CheckCircleOutlined, QrcodeOutlined, SafetyOutlined, GlobalOutlined } from '@ant-design/icons';
    ...
    const features = [
        {
            ...
            description: 'Dễ dàng tìm kiếm và đặt mua vaccine từ các nhà cung cấp uy tín.',
            link: '/market'
        },
        {
        ...
        },
        {
            ...
            description: 'Theo dõi và quản lý hồ sơ tiêm chủng của bạn một cách an toàn.',
            link: '/documents'
        }
    ];
    ...
    const recentUpdates = [
        {
            ...
            type: 'new',
            date: '2024-03-15',
            description: 'Vaccine mới nhất đã được cập nhật để bảo vệ against các biến thể mới.'
        },
        {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="text-white">
                            ...
                            <p className="text-xl text-blue-100 mb-8">
                                Sử dụng công nghệ Blockchain để đảm bảo tính minh bạch và an toàn trong quá trình tiêm chủng
                            </p>
                            ...
                            <div className="relative max-w-md w-full ml-auto">
                                <div className="bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                                    <div className="flex justify-between items-center mb-4">
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900">Chứng nhận tiêm chủng</h3>
                                            <p className="text-sm text-gray-500">Mã số: VX-••••-••••-••••</p>
                                        </div>
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border border-gray-100 w-32">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <p className="text-xs font-medium text-center">Xác thực Blockchain</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-12 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900">Tính năng chính</h2>
            ...
            <section className="py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-sm p-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6">Cập nhật mới nhất</h2>
                        <List
                                    ...
                                    <List.Item.Meta
                                        title={
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Tag color={
                                                    item.type === 'new' ? 'blue' : 
                                                    item.type === 'campaign' ? 'green' : 
                                                    'purple'
                                                }>
                                                    {item.type === 'new' ? 'Mới' :
                                                     item.type === 'campaign' ? 'Chiến dịch' :
                                                     'Đối tác'}
                                                </Tag>
                                            </div>
                                        }
            ...
            <section className="bg-blue-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Bảo mật thông tin với Blockchain</h2>
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Hệ thống phi tập trung của chúng tôi đảm bảo dữ liệu tiêm chủng của bạn luôn riêng tư nhưng vẫn có thể xác minh bởi các bên được ủy quyền.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm transition-all duration-300 hover:shadow-md">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Dữ liệu bất biến</h3>
                            <p className="text-gray-600">
                                Khi đã được ghi lại trên blockchain, dữ liệu tiêm chủng của bạn không thể bị thay đổi hoặc xóa, ngăn chặn gian lận.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm transition-all duration-300 hover:shadow-md">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Xác minh tức thì</h3>
                            <p className="text-gray-600">
                                Các bên được ủy quyền có thể xác minh trạng thái tiêm chủng của bạn trong vài giây mà không ảnh hưởng đến quyền riêng tư.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm transition-all duration-300 hover:shadow-md">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Truy cập toàn cầu</h3>
                            <p className="text-gray-600">
                                Hộ chiếu vaccine số của bạn hoạt động ở mọi nơi, được công nhận xuyên biên giới và các hệ thống y tế.
                            </p>
                        </div>
                    </div>
                </div>
